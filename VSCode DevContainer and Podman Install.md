## Steps to install Jekyll al-folio Site
...
3. Install git through notification box
4. Option Dev > Containers: Docker Path (dev.containers.dockerPath): set to `/usr/bin/podman`
...
5. Choose "Reopen in Container" in VSCode
